...
{
    data[0] = HBYTE (HOST_IDENTIFY);
	data[1] = LBYTE (HOST_IDENTIFY);
	data[2] = 0;
	data[3] = host.lastFrame.dataLen+4;
	data[4] = HBYTE (host.lastFrame.number);
	data[5] = LBYTE (host.lastFrame.number);
	data[6] = host.parsers[0].addr ;
	data[7] = HOST_TYPE_ASK;
	data[8] = host.lastFrame.command;
	data[9] = host.lastFrame.sub;
    memcpy((BYTE*)&data[10],host.lastFrame.data,host.lastFrame.dataLen+2);
}
/********************************************************************
 *
 *******************************************************************/
