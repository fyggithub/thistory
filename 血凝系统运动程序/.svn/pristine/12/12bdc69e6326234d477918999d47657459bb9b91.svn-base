 ...
 *
 *******************************************************************/
STATIC BOOL  HostCmdHeatEnable (HostFrame* frame)
{
    Message msg;
    msg.id = MSG_ENABLE_HEAT;
    msg.p1 = frame->data[0];
    MessagePost(&msg);
    return TRUE;
}
 ...
 *
 *******************************************************************/
STATIC UINT32 HostHeatParser(HostFrame* frame)
{
	...
	case HOST_CMD_TEMPERATURE_ENABLE : ret = HostCmdHeatEnable (frame);     break;
 ...
 * 
*******************************************************************/
VOID HostHeatInit(VOID)
{
    HostParserRegister (HOST_ADDR_HEAT, HostHeatParser); 
