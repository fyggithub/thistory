		...
		if(liquidSumTimer >= 10){
            ...
            if(liquidMeanValue > thresholdUint16){
                ...
                if(greaterThanThresholdTimes>THRESHOLDTIMES){
					TimerTest(); 
					if(0 == GpioGet(BoardGetGpio(F2LIQUID))) YMflag = 1;						
                }
            }
            else
...
{
    DOUBLE temp = (((DOUBLE)(adjMeanValue & 0x0FFF))*3.3)/4096;
    return temp;
}
/********************************************************************
 *
...
{
    DOUBLE temp = ((DOUBLE)(liquidMeanValue & 0x0FFF)/4096)*3.3;
    return temp;
}
/********************************************************************
 * END OF FILE
